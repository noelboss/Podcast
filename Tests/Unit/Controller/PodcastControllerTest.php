...
/**
 * Test case for class Tx_Podcast_Controller_PodcastController.
 *
 * @version $Id$
 ...
 */
class Tx_Podcast_Controller_PodcastControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
