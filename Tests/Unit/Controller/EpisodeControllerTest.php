...
/**
 * Test case for class Tx_Podcast_Controller_EpisodeController.
 *
 * @version $Id$
 ...
 */
class Tx_Podcast_Controller_EpisodeControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
