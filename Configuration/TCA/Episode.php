...
$TCA['tx_podcast_domain_model_episode'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'title,subtitle,description,file,publication_date,website,author,itunesblock,duration,mime'
	),
	'types' => array(
	...
	'palettes' => array(
		...
		'2' => array('showitem' => 'duration,mime'),
	),
	'columns' => array(
		...
		'keywords' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:podcast/Resources/Private/Language/locallang_db.xml:tx_podcast_domain_model_episode.keywords',
			'config' => array(
				'type' => 'select',
