...
/**
 * Controller for the Website object
 *
 * @version $Id$
...
class Tx_Podcast_Controller_WebsiteController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	...
	protected function initializeAction() {
		$this->websiteRepository = t3lib_div::makeInstance('Tx_Podcast_Domain_Repository_WebsiteRepository');
	}
